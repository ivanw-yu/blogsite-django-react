...
SECRET_KEY = '(955#17nfw&6p(95#o1y)wons$7q219fo^9zr78-adt=_cfjw&'
...
# Set custom model to user.User
AUTH_USER_MODEL = "user.User"

# Set the authentication backends to MyJWTAuthentication
# AUTHENTICATION_BACKENDS = [
#     "user.backends.MyJWTAuthentication"
# ]

REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': ('user.authentications.MyJWTAuthentication',)
}
